        ...
        this.view.getjButtonSalvar().addActionListener((ActionEvent e) -> {
            try {
                ...
                if((!user.isEmpty() || !user.equals("")) && (!pass.isEmpty() || !pass.equals(""))){
                    ...
                    JOptionPane.showMessageDialog(null, "Favor inserir um usuario valido e senha validos!");
                }
            } catch (SQLException ex) {
                JOptionPane.showMessageDialog(null, ex.getMessage());
            } catch (Exception ex) {
                JOptionPane.showMessageDialog(null, "Insira um usuário e senha validos!");
            }
        });
